...
<div id="wrapper">
  <header id="header" role="banner">
    ...
    <?php endif; ?>
    <?php if ($site_name): ?>
    <h1 id="site-title"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>"><?php print $site_name; ?></a></h1><?php endif; ?>
        ...
        <article class="post">
          <div class="entry-container">
            ...
            <div class="entry-summary">
              <?php print $slide1_desc; ?>            </div><!-- .entry-summary -->
            <div class="clear"></div>
          </div><!-- .entry-container -->
          <a href="<?php print url($slide1_url); ?>">
            ...
            <?php else: ?>
              <img src="<?php print base_path() . drupal_get_path('theme', 'professional_theme') . '/images/slide-image-1.png'; ?>" class="slide-image" alt="<?php print $slide_alt; ?>" /></a>
            <?php endif; ?>
          <div class="clear"></div>
        </article>
      </li>
      ...
      <li>
        <article class="post">
          <div class="entry-container">
            ...
            <div class="entry-summary">
              <?php print $slide2_desc; ?>            </div><!-- .entry-summary -->
            <div class="clear"></div>
          </div><!-- .entry-container -->
      ...
      <li>
        <article class="post">
          <div class="entry-container">
            ...
            <div class="entry-summary">
              <?php print $slide3_desc; ?>            </div><!-- .entry-summary -->
            <div class="clear"></div>
          </div><!-- .entry-container -->
        ...
        <article class="post">
          <div class="entry-container">
            ...
            <div class="entry-summary">
              <?php print $slide4_desc; ?>            </div><!-- .entry-summary -->
            <div class="clear"></div>
          </div><!-- .entry-container -->
          <a href="<?php print url($slide4_url); ?>">
            ...
            <?php else: ?>
              <img src="<?php print base_path() . drupal_get_path('theme', 'professional_theme') . '/images/slide-image-6.jpg'; ?>" class="slide-image" alt="<?php print $slide4_alt; ?>" /></a>
            <?php endif; ?>
          <div class="clear"></div>
        </article>
      </li>
        ...
        <article class="post">
          <div class="entry-container">
            ...
            <div class="entry-summary">
              <?php print $slide5_desc; ?>            </div><!-- .entry-summary -->
            <div class="clear"></div>
          </div><!-- .entry-container -->
